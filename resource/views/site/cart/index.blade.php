	...
	<div class="row">
					...
					@foreach($products as $product)
						...
						<form action="{{ route('site.cart.update') }}" method="POST">
							...
							<tr>
								...
								<td style="max-width: 150px;"><a href="{{ route('site.products.show', ['slug' => $product->product->slug]) }}" title="Var mais sobre: {{ $product->product->name }}" target="_blank">{{ $product->product->name }} <i class="fa fa-external-link"></i></a></td>
								<td>
		...
		<div class="col-md-4">
			<div class="card">
				...
				<div class="card-body" style="border: 1px solid #D9D9D9; padding: 20px;">
					<div>
