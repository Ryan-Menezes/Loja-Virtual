...
--
-- Host: 127.0.0.1
-- Generation Time: 10-Jan-2022 às 02:47
...
(34, 'Camisa Formal', 'camisa-formal', 'Camisa formal', 'Camisa Formal', '', 1, 1, 0, 1, '2021-12-18 22:21:42', '2022-01-04 18:18:32'),
(35, 'XBox Series X', 'xbox-series-x', 'Novo videogame da microsoft', '', NULL, 1, 1, 0, 1, '2021-12-18 22:29:43', '2021-12-19 15:19:01'),
(36, 'Playstation 5', 'playstation-5', 'Novo videogame da sony', '', NULL, 1, 1, 0, 1, '2021-12-18 22:35:10', '2021-12-19 15:19:01'),
...
-- Error reading data for table lojavirtual.product_colors: #1064 - Você tem um erro de sintaxe no seu SQL próximo a 'FROM `lojavirtual`.`product_colors`' na linha 1
...
(153, '12 Polegadas', '1200.00', '2000.00', 10, 60, 60, 60, 80, 45);
...
INSERT INTO `system_store` (`id`, `payment_type`, `payment_credit_card`, `payment_debit_card`, `payment_bolet`, `payment_debit_online`, `payment_pix`, `payment_paypal`) VALUES
(1, 'PS', 1, 1, 1, 1, 0, 1),
(2, 'PS', 1, 1, 1, 1, 1, 1);
