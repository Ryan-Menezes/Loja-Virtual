...
class FreteShoppingCorreios extends FreteCorreios {
	public function calculate(string $nCdServico = self::PAC) : ?array{
		try {
			...
			$url = "https://shopping.correios.com.br/wbm/shopping/script/CalcPrecoPrazo.asmx/CalcPrecoPrazo?nCdEmpresa={$this->nCdEmpresa}&sDsSenha={$this->sDsSenha}&" . http_build_query($data);
